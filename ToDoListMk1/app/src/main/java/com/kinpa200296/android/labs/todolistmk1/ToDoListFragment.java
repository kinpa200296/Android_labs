...
public class ToDoListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        repository.load(getActivity().getSharedPreferences(ToDoRepository.PREFERENCES_NAME, Context.MODE_PRIVATE));
    ...
    public void onPause() {
        super.onPause();
        repository.save(getActivity().getSharedPreferences(ToDoRepository.PREFERENCES_NAME, Context.MODE_PRIVATE));
    }
